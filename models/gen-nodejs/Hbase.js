  ...
  if (this.attributes !== null && this.attributes !== undefined) {
    ...
    for (var kiter92 in this.attributes)
    {
      if (this.attributes.hasOwnProperty(kiter92))
      {
        ...
        output.writeString(kiter92);
        output.writeString(viter93);
      }
    }
    output.writeMapEnd();
    output.writeFieldEnd();
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i423 = 0; _i423 < _size418; ++_i423)
        {
          var key424 = null;
          var val425 = null;
          key424 = input.readString();
          val425 = input.readString();
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i461 = 0; _i461 < _size456; ++_i461)
        {
          var key462 = null;
          var val463 = null;
          key462 = input.readString();
          val463 = input.readString();
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i488 = 0; _i488 < _size483; ++_i488)
        {
          var key489 = null;
          var val490 = null;
          key489 = input.readString();
          val490 = input.readString();
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i506 = 0; _i506 < _size501; ++_i506)
        {
          var key507 = null;
          var val508 = null;
          key507 = input.readString();
          val508 = input.readString();
  ...
  if (this.attributes !== null && this.attributes !== undefined) {
    ...
    for (var kiter510 in this.attributes)
    {
      if (this.attributes.hasOwnProperty(kiter510))
      {
        ...
        output.writeString(kiter510);
        output.writeString(viter511);
      }
    }
    output.writeMapEnd();
    output.writeFieldEnd();
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i524 = 0; _i524 < _size519; ++_i524)
        {
          var key525 = null;
          var val526 = null;
          key525 = input.readString();
          val526 = input.readString();
  ...
  if (this.attributes !== null && this.attributes !== undefined) {
    ...
    for (var kiter528 in this.attributes)
    {
      if (this.attributes.hasOwnProperty(kiter528))
      {
        ...
        output.writeString(kiter528);
        output.writeString(viter529);
      }
    }
    output.writeMapEnd();
    output.writeFieldEnd();
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i542 = 0; _i542 < _size537; ++_i542)
        {
          var key543 = null;
          var val544 = null;
          key543 = input.readString();
          val544 = input.readString();
  ...
  if (this.attributes !== null && this.attributes !== undefined) {
    ...
    for (var kiter546 in this.attributes)
    {
      if (this.attributes.hasOwnProperty(kiter546))
      {
        ...
        output.writeString(kiter546);
        output.writeString(viter547);
      }
    }
    output.writeMapEnd();
    output.writeFieldEnd();
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i560 = 0; _i560 < _size555; ++_i560)
        {
          var key561 = null;
          var val562 = null;
          key561 = input.readString();
          val562 = input.readString();
